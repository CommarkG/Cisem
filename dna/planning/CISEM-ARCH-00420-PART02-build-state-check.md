...
**Type:** ARCH | **Status:** ACTIVE | **Planning Status:** COMPLETE — Governor-RATIFIED 2026-07-24 + BUILT + VERIFIED (deliverable on disk + planted test passes both directions + acid test defeats the RI-0012-in-itself trap; Opus-verified, not self-reported)
...
- v1.0 2026-07-24 (Governor-RATIFIED → Sonnet-BUILT → Opus-VERIFIED) — build-state.sh (113 lines) + 3 fixtures + run-test.sh harness + wired into plan-audit.sh (ZF formula untouched). Opus independently ran (not self-report, RI-0004): planted test PASSES both directions; acid test PROVEN live — ARCH-00392/00406 ("IN-PROGRESS — Governor RATIFIED …") correctly NOT selected (token-anchor defeats the RI-0012-in-itself trap). LIVE RUN result: 1 WARN — ARCH-00410 → frontend/js/mindmap.js absent. OPUS RULING: heuristic FALSE-POSITIVE correctly surfaced (deliverable = "mindmap.js OR EQUIVALENT, NOT built by this drafting task"; the equivalent WAS built in frontend/js/search.js initMindmap; "NOT built by" is outside the ratified marker vocab, "or equivalent" is path-flexible). NOT a real RI-0027 gap; validates WARN+oversight design. ROUTED follow-ons (NOT self-implemented — marker vocab is ratified, Core-Seed integrity): (F1) marker-vocab addition "NOT built by"/"or equivalent"; (F2) "X or equivalent" → EDGE-not-FLAG; (F3) ARCH-00410 plan-accuracy fix (names mindmap.js, reality = search.js). Planning Status → COMPLETE (built+verified, honest per this plan's own dogfood rule).
