...
- **T1 Conflict model** (triage / vault-drain / provisional-expiry)
- **T2 Sealed-boundary + re-grounding** (defeasibility / inheritance propagation)
- **T3 Significance criterion** (reach / impact / stability)
- **T4 Development method** (build-to-flawless / triangulation / stopping-rule)
- **T5 Self-governance & blind spots** (independence / echo-chamber / meta-governance)
...
## 4. DOES-NOT / GUARDS
- Does NOT ratify, fold, or act on the content (that is a later, deliberate consolidation).
- Does NOT strip safety-relevant semantics under the banner of de-branding (Security lens §1).
- Does NOT treat convergence across reviewers as proof (triangulation is evidence; still verify — I22).
